...
public class KochkurveGUI extends JFrame {
  ...
  public void pythagorasBaum(double laenge, int t) {
      turtle.fd(laenge);
      turtle.right(90);
      turtle.fd(laenge);
      turtle.right(90);
      ...
      turtle.fd(laenge/2);
      turtle.right(90);
      pythagorasBaum(laenge/2,t-1);
    
    
  }

  //Leitprogramm Rekursives Programmieren. Kapitel 4 Programmieraufgabe 6
  public void zeichneDrachen(int t, int vz, double laenge) {
    if (t==0) {
      turtle.fd(laenge);
    } else {
      zeichneDrachen(t-1,1,laenge/2);
      turtle.left(vz*90);
      zeichneDrachen(t-1,-1,laenge/2);
    } // end of if-else
  }
  ...
  public void jbtnPythagorasBaum_ActionPerformed(ActionEvent evt) {
    ...
    //Turtle Positionieren
    turtle.setPos(-(laenge/2), 0);
    turtle.setAngle(90);

    pythagorasBaum(laenge,t);
