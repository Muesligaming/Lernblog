...
public class Faehre {
  // Anfang Attribute
  private Stack<Auto> reihe1 = new Stack<Auto>(); /** Stack für die erste Spur mit dem Namen reihe1*/
  //TODO
  private Stack<Auto> reihe2 = new Stack<Auto>();/** Stack für die zweite Spur  mit dem Namen reihe2*/
  //TODO
  private Stack<Auto> reihe3 = new Stack<Auto>();/** Stack für die dritte Spur  mit dem Namen reihe3*/
  //TODO
  private Stack<Auto> wartereihe = new Stack<Auto>();/** Stack für die Wartespur  mit dem Namen wartereihe*/
  //TODO
  ...
  */
  public double restlaenge() {
    ...
    while (!wartereihe.isEmpty()) { 
      rest+=erstesWartendesAuto().getLaenge();
      wartereihe.pop();
    } // end of while
  ...
  * Alle Reihen immer möglichst kurz halten 
  * @return reihe, in die das aktuell wartende Auto zugewiesen wird.
  */
  public int strategieA() {
    if (freiReihe1>=freiReihe2&&freiReihe1>=freiReihe3) {
      if (freiReihe1 > erstesWartendesAuto().getLaenge()) {
        this.inReiheFahren(1);
        return 1;
      } // end of if
    } else if (freiReihe2>freiReihe1&&freiReihe2>=freiReihe3) {
      if (freiReihe2>erstesWartendesAuto().getLaenge()) {
        this.inReiheFahren(2);  
        return 2;
      } // end of if  
    } else if (freiReihe3>freiReihe2&&freiReihe3>freiReihe1) {
      if (freiReihe3>erstesWartendesAuto().getLaenge()) {
        this.inReiheFahren(3);    
        return 3;
      } // end of if 
    }else {
        return 0;
  ...
  *Alle Rheihen möglichst voll machen. 
  * @return reihe, in die das aktuell wartende Auto zugewiesen wird.
  */
